...
def test_summary_basic_functionality(simple_data):
    ...
    expected_rows = [
        'na_count', 'na_pct_per_col', 'na_pct_total', 
        'na_unique_per_col', 'na_unique_pct_per_col',
        'rows_after_dropna', 'rows_after_dropna_pct'
    ]
...
def test_summary_per_column_false(simple_data):
    ...
    expected_rows = [
        'total_cols', 'na_cols', 'na_only_cols', 'total_rows',
        'na_rows', 'non_na_rows', 'total_cells', 'na_cells',
        'na_cells_pct', 'non_na_cells', 'non_na_cells_pct'
    ]
    for row in expected_rows:
        assert row in result.index
